...
token = '7536999813:AAH-QUKswuifQmkiyP7QJeO6Xwn5u0roPAc'
	...
	try:
		with open("combo.txt", 'r') as file:
			...
			for cc in lino:
				...
				bot.edit_message_text(chat_id=message.chat.id, message_id=ko, text='''Processing Cards
Made by  ➜ @Parth_genzy ''', reply_markup=mes)
